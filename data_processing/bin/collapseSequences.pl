...
foreach my $k (keys %unique){
  ...
  print $outgtf join("\t",@line[0..1]) . "\texon\t" . join("\t",@line[3..7]) . "\tgene_id \"$geneid\"; transcript_id \"$geneid\_t\"; gene_type \"mature_tRNA\"; gene_name \"$genename\"; transcript_type \"mature_tRNA\"; transcript_name \"$genename\"; level 2; exon_number 1;\n";
